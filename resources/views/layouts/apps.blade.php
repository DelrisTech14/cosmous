...
<head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/img/cosmos-logo.png')}}">
                            	...
                            	<div class="mobile-menu">
	                                <nav id="mobile-menu">
	                                    <ul>
	                                        ...
	                                        <li><a href="{{url('/dashboard/shopping')}}">Shop</a>
		                                        <!-- <ul>
                            ...
                            <div class="col-12 col-md-12 col-lg-2">
                            	<div class="logo">
                            		<a href="{{url('/dashboard')}}">
                            			<img src="{{asset('images/' . $data['app'][0]->image)}}" alt="logo">
                            		</a>
                            	</div>
                            </div>
                                ...
                                <div class="header-top-left-menu ps-5">
                                    <nav>
                                        <ul>
											...
											<li><a href="{{route('about.index')}}">About</a></li>
                                            <li><a href="{{route('shopping.index')}}">Shop</a>
		                                        <!-- <ul>
													<li><a href="shop-right-sidebar.php">Shop Right Sidebar</a></li>
													<li><a href="shop-list.php">Shop List</a></li>
													<li><a href="product-details.php">Product Details</a></li>
	            	...
	            	<div class="container">
	            		<div class="row">
							<div class="col-12 col-sm-6 col-md-3">
								<div class="single-foo-service">
									<div class="single-foo-service-image">
										<img src="{{asset('assets/img/service/service_icon1.png')}}" alt="service_icon">
									</div>
							...
							<div class="col-12 col-sm-6 col-md-3">
								<div class="single-foo-service">
									<div class="single-foo-service-image">
										<img src="{{asset('assets/img/service/service_icon2.png')}}" alt="service_icon">
									</div>
									<div class="single-foo-service-content">
										<h5>TRUSTPAY</h5>
										<p>Moving your card details to a much more secured place</p>
							...
							<div class="col-12 col-sm-6 col-md-3">
								<div class="single-foo-service">
									<div class="single-foo-service-image">
										<img src="{{asset('assets/img/service/service_icon3.png')}}" alt="service_icon">
									</div>
									<div class="single-foo-service-content">
										<h5>HELP CENTER</h5>
							...
							<div class="col-12 col-sm-6 col-md-3">
								<div class="single-foo-service">
									<div class="single-foo-service-image">
										<img src="{{asset('assets/img/service/service_icon4.png')}}" alt="service_icon">
									</div>
									<div class="single-foo-service-content">
            				...
            				<div class="col-12 col-sm-6 col-md-6 col-lg-4">
	            				<div class="footer-about-us">
	            					<div class="logo-footer">
	            						<a href="index.php">
	            							<img src="{{asset('images/' . $data['app'][0]->image)}}" alt="footer logo">
	            						</a>
	            					</div>
	            					<div class="footer-content">
	            						<p>{{ $data['app'][0]->description}}</p>
        					...
        					<div class="col-12 col-sm-6 col-md-6 col-lg-3">
        						<div class="footer-menu">
        							...
        							<ul>
									    ...
									    <li><a href="{{url('/cart/add')}}">My cart</a></li>
									...
									<h4>Contact info</h4>
										...
										<ul class="social-icon">
											<li>
												...
												<a href=""><i class="fa fa-mobile" aria-hidden="true"></i>{{ $data['app'][0]->number}}</i></a>
											</li> 
											<li>
												<a href=""><i class="fa fa-envelope" aria-hidden="true"></i>{{ $data['app'][0]->email}}</i> </a>
											</li>
											<li>
												<a href=""><i class="fa fa-map-marker" aria-hidden="true"></i>{{ $data['app'][0]->address}} </i></a>
											</li>
										</ul>
									</div>
								...
								<div class="col-12 col-sm-6">
									<div class="single-product-image">
										<div class="quickview-fotorama">
											<a href="{{asset('assets/img/Jawan-min.png')}}">
												<img src="{{asset('assets/img/Jawan-min.png')}}" alt="product image">
											</a>
											<a href="{{asset('assets/img/product/torch2.webp')}}">
												<img src="{{asset('assets/img/product/torch2.webp')}}" alt="product image">
											</a>
											<a href="{{asset('assets/img/product/torch5.webp')}}">
												<img src="{{asset('assets/img/product/torch5.webp')}}" alt="product image">
											</a>
											<a href="{{asset('assets/img/product/torch7.webp')}}">
												<img src="{{asset('assets/img/product/torch7.webp')}}" alt="product image">
											</a>
											<a href="{{asset('assets/img/product/torch9.webp')}}">
												<img src="{{asset('assets/img/product/torch9.webp')}}" alt="product image">
											</a>
											<a href="{{asset('assets/img/product/torch10.webp')}}">
												<img src="{{asset('assets/img/product/torch10.webp')}}" alt="product image">
											</a>
										</div>
									</div>							
								</div>
