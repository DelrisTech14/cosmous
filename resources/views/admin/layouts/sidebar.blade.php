<!-- /.navbar -->
			...
			<aside class="main-sidebar sidebar-dark-primary elevation-4">
				...
				<a href="#" class="brand-link">
					<img src="{{asset('assets/img/tractor-min.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
				...
				<div class="sidebar">
					...
					<nav class="mt-2">
						<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
							...
							<li class="nav-item">
								<a href="{{route('pro.view')}}" class="nav-link">
									<i class="nav-icon fas fa-file-alt"></i>
									<p>Products</p>
								</a>
							</li>
							...
							<li class="nav-item">
								<a href="{{route('expert.view')}}" class="nav-link">
									<i class="nav-icon fas fa-file-alt"></i>
									<p>Our Experts</p>
								</a>
							</li>
