...
@section('content')
            ...
            <section class="slider-area">
				<div class="slider-active owl-carousel">
				  ...
				  <img src="{{asset('assets/img/slider/Banner-1.jpg')}}" alt="">
					<div class="container">
						<div class="row">
    ...
    @foreach($banners as $banner)
								<h2>
										<span class="secondry-color">{{ isset($banner->title) ? $banner->title : '' }}</span>
										<strong>{{ $banner->description }} <br> {{ $banner->description }}</strong>
									</h2>
									<h4>
										<span class="secondry-color">{{ $banner->description }}</span>  {{ $banner->description }}<span class="secondry-color"> {{ $banner->description }} </span> <br>  {{ $banner->description }}
									</h4>
									@endforeach
@else
...
@endif
									...
									<div class="slider-button default-button">
										<a href="{{route('shopping.index')}}">shop now</a>
									</div>
								</div>
							</div>
						</div>
				  ...
				  <div class="single-slide" style="background-image:url('');">
				  <img src="{{asset('assets/img/slider/Banner-2.jpg')}}" alt="">
					<div class="container">
						<div class="row">
							<div class="col-sm-10 col-md-8 col-lg-6">
								<div class="slider-content">
            				...
            				<div class="hot-deal-product-wrapper">
            					<div class="hot-deal-product-inner">
            						<div class="hot-deal-slider slider-contral2 owl-carousel">
            							<div class="hot-deal-single-item">
            								<div class="hot-deal-image">
            									<a href="{{route('product.index')}}">
													<img src="{{asset('assets/img/Tractor-min.png')}}" alt="product">
												</a>
            								...
            								<div class="hot-deal-content">
            									<h3><a href="{{route('product.index')}}">TRACTOR</a></h3>
            									<div class="hot-price">
												...
												<div class="default-button">
													<a href="{{url('/dashboard/cart')}}">ADD TO CART</a>
												</div>
            								</div>
            							</div>
            							<div class="hot-deal-single-item">
            								<div class="hot-deal-image">
            									<a href="{{route('product.index')}}"><img src="{{asset('assets/img/Sir John-min.png')}}" alt="product"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
            								...
            								<div class="hot-deal-content">
            									<h3><a href="{{route('product.index')}}">SIR JOHN</a></h3>
            									<div class="hot-price">
            							...
            							<div class="hot-deal-single-item">
            								<div class="hot-deal-image">
            									<a href="{{route('product.index')}}"><img src="{{asset('assets/img/Sartaj-min.png')}}" alt="product"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
            								...
            								<div class="hot-deal-content">
            									<h3><a href="{{route('product.index')}}">SIRTAJ</a></h3>
            									<div class="hot-price">
            					...
            					<div class="best-seller sidebar-product-inner">
            						<div class="single-sidebar-product">
        								...
        								<div class="sidebar-main-content">
        									...
        									<a href="{{route('product.index')}}">Natural professor</a>			
            							</div>
            						</div>
            						<div class="single-sidebar-product">
        								<div class="single-sidebar-image">
        									<a href="{{route('product.index')}}"><img src="assets/img/product/torch3.jpg" alt="product"></a>
        								</div>
        								<div class="sidebar-main-content">
        									<div class="price-box">
        										<span class="regular-price">₹350.00</span>
        									</div>
        									<a href="{{route('product.index')}}">Specimen animal</a>			
            							</div>
            						</div>
            						<div class="single-sidebar-product">
        								<div class="single-sidebar-image">
        									<a href="{{route('product.index')}}"><img src="assets/img/product/torch4.jpg" alt="product"></a>
        								</div>
        								<div class="sidebar-main-content">
        									<div class="price-box">
        										<span class="regular-price">₹220.00</span>
        									</div>
        									<a href="{{route('product.index')}}">Bakkas course Korbo</a>			
            							</div>
            						</div>
            						<div class="single-sidebar-product">
        								<div class="single-sidebar-image">
        									<a href="{{route('product.index')}}"><img src="assets/img/product/torch5.jpg" alt="product"></a>
        								</div>
        								<div class="sidebar-main-content">
        									<div class="price-box">
        										<span class="regular-price">₹130.00</span>
        									...
        									<a href="{{route('product.index')}}">Simply electronic</a>			
            							</div>
            						</div>
            						<div class="single-sidebar-product">
        								<div class="single-sidebar-image">
        									<a href="{{route('product.index')}}"><img src="assets/img/product/torch6.jpg" alt="product"></a>
        								</div>
        								<div class="sidebar-main-content">
        									<div class="price-box">
        										<span class="regular-price">₹520.00</span>
        									</div>
        									<a href="{{route('product.index')}}">Dummy electronic</a>			
            							</div>
            						</div>
            						<div class="single-sidebar-product">
        								<div class="single-sidebar-image">
        									<a href="{{route('product.index')}}"><img src="assets/img/product/torch7.jpg" alt="product"></a>
        								</div>
        								<div class="sidebar-main-content">
        									<div class="price-box">
        										<span class="regular-price">₹130.00</span>
        									...
        									<a href="{{route('product.index')}}">Donec eu electronic</a>			
            							</div>
            						</div>
            					</div>
            				</div>            				
								    ...
								    <div class="home-tab-carousel product-grid-wrapper">
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			...
								    			<a href="{{route('product.index')}}"><img src="assets/img/product/torch1.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    		...
								    		<div class="grid-product-info">
	        									...
	        									<a href="{{route('product.index')}}">Dolorum fuga</a>
								    		</div>
								    	</div>
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<a href="{{route('product.index')}}"><img src="assets/img/product/torch2.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    		...
								    		<div class="grid-product-info">
	        									...
	        									<a href="{{route('product.index')}}">Condimentum Cap</a>
								    		</div>
								    	</div>
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<a href="{{route('product.index')}}"><img src="assets/img/product/torch5.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    		...
								    		<div class="grid-product-info">
	        									...
	        									<a href="{{route('product.index')}}">typesetting electronic</a>
								    		</div>
								    	</div>
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<span class="sale">-65%</span>
								    			<a href="{{route('product.index')}}"><img src="assets/img/product/torch7.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    		...
								    		<div class="grid-product-info">
	        									...
	        									<a href="{{route('product.index')}}">Laudantium furniture</a>
								    		</div>
								    	</div>
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<a href="{{route('product.index')}}"><img src="assets/img/product/torch9.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    	...
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<a href="{{route('product.index')}}"><img src="assets/img/product/torch10.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    	...
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<a href="{{route('product.index')}}"><img src="assets/img/product/torch11.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    ...
						    <div class="cat-slider1 product-grid-wrapper">
						    	...
						    	<div class="single-grid-product">
						    		...
						    		<div class="grid-product-info">
										...
										<a href="{{route('product.index')}}">Dummey headphone</a>
						    		</div>
						    	</div>
						    </div>	
						    ...
						    <div class="cat-slider2 product-grid-wrapper">
						    	...
						    	<div class="single-grid-product">
						    		...
						    		<div class="grid-product-info">
										...
										<a href="{{route('product.index')}}">Darun court</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    		...
						    		<div class="grid-product-info">
										...
										<a href="{{route('product.index')}}">Chokra bokra shirt</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    		...
						    		<div class="grid-product-info">
										...
										<a href="{{route('product.index')}}">Chawal manser pantu</a>
						    		</div>
						    	</div>
						    </div>	
							<div class="category-btn default-button">
            		...
            		<div class="row">
            			<div class="col-12 col-sm-12">
						    ...
						    <div class="carousel-product product-grid-wrapper">
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    			<a href="{{route('product.index')}}"><img src="{{asset('assets/img/Sartaj-min.png')}}" alt="product grid"></a>
    									<div class="product-action">
    										<a href="#"><i class="material-icons">favorite_border</i></a>
    										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
    										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
    									</div>
    									<a class="grid-btn" href="{{url('/dashboard/cart')}}">Add to Cart</a>
						    		</div>
						    		<div class="grid-product-info">
    									<div class="price-box">
    										<span class="regular-price">₹170.00</span>
    									</div>
    									<a href="{{route('product.index')}}">SIRTAJ</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    			<span class="sale">-25%</span>
						    			<a href="{{route('product.index')}}"><img src="{{asset('assets/img/Excel-min.png')}}" alt="product grid"></a>
    									<div class="product-action">
    										<a href="#"><i class="material-icons">favorite_border</i></a>
    										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
    										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    		...
						    		<div class="grid-product-info">
    									...
    									<a href="{{route('product.index')}}">EXCEL</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    			<a href="{{route('product.index')}}"><img src="{{asset('assets/img/Pratap-min.png')}}" alt="product grid"></a>
    									<div class="product-action">
    										<a href="#"><i class="material-icons">favorite_border</i></a>
    										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
    										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    		...
						    		<div class="grid-product-info">
    									...
    									<a href="{{route('product.index')}}">PRATAP</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    			<a href="{{route('product.index')}}"><img src="{{asset('assets/img/UP Nano-min.png')}}" alt="product grid"></a>
    									<div class="product-action">
    										<a href="#"><i class="material-icons">favorite_border</i></a>
    										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
    										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    		...
						    		<div class="grid-product-info">
    									...
    									<a href="{{route('product.index')}}">UP NANO</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    			<span class="sale">-15%</span>
						    			<a href="{{route('product.index')}}"><img src="{{asset('assets/img/Vijayshri-min.png')}}" alt="product grid"></a>
    									<div class="product-action">
    										<a href="#"><i class="material-icons">favorite_border</i></a>
    										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
    										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    		...
						    		<div class="grid-product-info">
    									...
    									<a href="{{route('product.index')}}">VIJAYSHRI</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    			<a href="{{route('product.index')}}"><img src="{{asset('assets/img/Raftaar-min.png')}}" alt="product grid"></a>
    									<div class="product-action">
    										<a href="#"><i class="material-icons">favorite_border</i></a>
    										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
    										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    		...
						    		<div class="grid-product-info">
    									...
    									<a href="{{route('product.index')}}">RAFTAR</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    			<a href="{{route('product.index')}}"><img src="{{asset('assets/img/Jawan-min.png')}}" alt="product grid"></a>
    									<div class="product-action">
    										<a href="#"><i class="material-icons">favorite_border</i></a>
    										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
    										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    		...
						    		<div class="grid-product-info">
    									...
    									<a href="{{route('product.index')}}">Jawan</a>
						    		</div>
						    	</div>								    	
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    			<span class="sale">-20%</span>
						    			<a href="{{route('product.index')}}"><img src="{{asset('assets/img/Kohinoor-min.png')}}" alt="product grid"></a>
    									<div class="product-action">
    										<a href="#"><i class="material-icons">favorite_border</i></a>
    										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
    										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    		...
						    		<div class="grid-product-info">
    									...
    									<a href="{{route('product.index')}}">Kohinoor</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    			<a href="{{route('product.index')}}"><img src="{{asset('assets/img/Sir John-min.png')}}" alt="product grid"></a>
    									<div class="product-action">
    										<a href="#"><i class="material-icons">favorite_border</i></a>
    										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
    										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    		...
						    		<div class="grid-product-info">
    									...
    									<a href="{{route('product.index')}}">SIR JOHN</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
								<img src="{{asset('assets/img/Tractor-min.png')}}" alt="">
							</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
								<img src="{{asset('assets/img/Raftaar-min.png')}}" alt="">
							</div>
							<div class="featured-product-content">
								<h5>Raftaar </h5>
							</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
								<img src="{{asset('assets/img/Excel-min.png')}}" alt="">
							</div>
							<div class="featured-product-content">
								<h5>EXCEL </h5>
							</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
								<img src="{{asset('assets/img/Kohinoor-min.png')}}" alt="">
							</div>
							<div class="featured-product-content">
								<h5>Kohinoor </h5>
							</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
								<img src="{{asset('assets/img/Jawan-min.png')}}" alt="">
							</div>
							<div class="featured-product-content">
								<h5>Jawan </h5>
							</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
								<img src="{{asset('assets/img/Veer-min.png')}}" alt="">
							</div>
							<div class="featured-product-content">
								<h5>Veer </h5>
							</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
								<img src="{{asset('assets/img/UP Nano-min.png')}}" alt="">
							</div>
							<div class="featured-product-content">
								<h5>UP Nano </h5>
							</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
								<img src="{{asset('assets/img/Pratap-min.png')}}" alt="">
							</div>
							<div class="featured-product-content">
								<h5>Pratap </h5>
							</div>
