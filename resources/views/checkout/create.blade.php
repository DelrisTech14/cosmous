		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6 col-12">
                    ...
                    <input type="text" name="fname" id="fname" class="form-control" value="{{ old('fname') }}" placeholder="Enter First name">
                    @error('fname')
                    ...
                    @enderror
								...
								<div class="col-md-6">
									<div class="checkout-form-list">
										...
										<input type="text" name="lname" id="lname" class="form-control" value="{{ old('lname') }}" placeholder="Enter Last name">
                    @error('lname')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
									</div>
								...
								<div class="col-md-12">
									<div class="checkout-form-list">
										...
										<input type="text" name="address" id="lname" class="form-control" value="{{ old('address') }}" placeholder="Street address">
										@error('address')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
									</div>
                    ...
                    @enderror
								...
								<div class="order-notes">
									<div class="checkout-form-list">
										...
										<textarea name="description" id="description" class="form-control" value="{{ old('description') }}" placeholder="Notes about your order, e.g. special notes for delivery." rows="10" cols="30" id="checkout-mess"></textarea>
										@error('description')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
									</div>
	...
	<div class="col-md-6">
		...
		<input type="text" name="expiry_date" id="expiry_date" placeholder="MM/YYYY"/>
									...
									<div data-parent="#accordion" class="collapse" id="collapseThree">
										<div class="card-body">
										<p>Make your payment by master card. We support many card. Please use your Order ID as the payment reference. Your order won’t be shipped until the funds have cleared in our account. <br> <img src="{{asset('assets/img/payment-logo.png" alt="payment-logo')}}"></p>
