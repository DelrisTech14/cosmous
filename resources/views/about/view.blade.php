                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="about-content">
                            ...
                            <h3>{{ $data['aboutus'][0]->shortdescription }}</h3>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="about-image">
                            ...
                            <!--<img src="{{asset('assets/img/product/torch10.webp')}}" alt="about image">-->
                           
                            
                            <img src="{{ asset('images/' . $data['aboutus'][0]->image) }}" alt="Image">
                        </div>
                    </div>                  
                </div>                        
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 ">
                        <div class="team-wrapper">
                            <div class="team-img">
                                <img alt="team" src="{{ asset('images/' . $data['expert'][0]->image) }}">
                            </div>
                            <div class="team-content">
                            <h5>{{ $data['expert'][0]->name }}</h5>
                             <!--<h5>Joyce Jimenez</h5>-->
                             <span>{{ $data['expert'][0]->description }}</span>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 ">
                        <div class="team-wrapper">
                            <div class="team-img">
                                <img alt="team" src="{{asset('images/' . $data['expert'][1]->image)}}">
                            </div>
                            <div class="team-content">
                            <h5>{{ $data['expert'][1]->name }}</h5>
                                <span>{{ $data['expert'][1]->description }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 ">
                        <div class="team-wrapper">
                            <div class="team-img">
                                <img alt="team" src="{{asset('images/' . $data['expert'][2]->image)}}">
                            </div>
                            <div class="team-content">
                            <h5>{{ $data['expert'][2]->name }}</h5>
                                <span>{{ $data['expert'][2]->description }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 ">
                        <div class="team-wrapper">
                            <div class="team-img">
                                <img alt="team" src="{{asset('images/' . $data['expert'][3]->image)}}">
                            </div>
                            <div class="team-content">
                            <h5>{{ $data['expert'][3]->name }}</h5>
                                <span>{{ $data['expert'][3]->description }}</span>
                            </div>
                        </div>
                    </div>
                </div>                        
                        ...
                        <div class="testimonial-carousel client-testimonial owl-carousel">
                            <div class=" single-testimonial">
                                <div class="testimonial-image">
                                    <img src="{{asset('images/' . $data['testimonial'][0]->image)}}" alt="client">
                                </div>
                                <div class="testimonial-text">
                                    <p>{{ $data['testimonial'][0]->description }}</p>
                                   <!-- <p>{{ $data['testimonial'][0]->description }}</p>-->
                                   <h5>{{ $data['testimonial'][0]->name}}</h5>
                                    <!--<h5>{{ $data['testimonial'][0]->name}}</h5>-->
                                    <span>{{ $data['testimonial'][0]->shortdescription}}</span>
                            ...
                            <div class=" single-testimonial">
                                ...
                                <div class="testimonial-text">
                                    <p>{{ $data['testimonial'][0]->description }}</p>
                                    <h5>{{ $data['testimonial'][0]->name}}<span></span></h5>
                                    <span>Founder, Retroge LLC</span>
                                </div>
                            </div>
                            <div class=" single-testimonial">
