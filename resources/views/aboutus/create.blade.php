        ...
        <div class="col-md-6">
            <form action="{{route('aboutus.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" name="shortdescription" id="shortdescription" class="form-control" value="{{ old('shortdescription') }}" placeholder="Enter short description"></textarea>
