...
@section('content')
            ...
            <section class="slider-area">
				<div class="slider-active owl-carousel">
				  ...
				  <img src="{{asset('images/' . $data['banner'][0]->image)}}" alt="">
					<div class="container">
						<div class="row">
							<div class="col-sm-10 col-md-8 col-lg-6">
								<div class="slider-content">
                                    ...
                                    <span class="secondry-color"></span>
                                        ...
                                        <span class="secondry-color">{{ $data['banner'][0]->title}}</span>
										
										<!--<span class="secondry-color">monster</span>
										<strong>performance <br> for less</strong>-->
									</h2>
									<h4>
                                    <span class="secondry-color"></span> {{ $data['banner'][0]->description }}<span class="secondry-color"></span> <br>
				  ...
				  <div class="single-slide" style="background-image:url('');">
				  <img src="{{asset('images/' . $data['banner'][1]->image)}}" alt="">
					<div class="container">
						<div class="row">
							<div class="col-sm-10 col-md-8 col-lg-6">
								<div class="slider-content">
									<h2>
										<strong>{{ $data['banner'][1]->title}}</strong>
										<span></span>
									</h2>
									<h3>
                                    <span class="secondry-color"> {{ $data['banner'][1]->description}}</span>
									</h3>
									<div class="slider-button default-button">
            				...
            				<div class="hot-deal-product-wrapper">
            					<div class="hot-deal-product-inner">
            						<div class="hot-deal-slider slider-contral2 owl-carousel">
            							<div class="hot-deal-single-item">
            								<div class="hot-deal-image">
            									<a href="{{route('products')}}">
													<img src="{{asset('images/' . $data['product'][0]->image)}}" alt="product">
												</a>
											...
											<h3><a href="{{route('products')}}"> {{ $data['product'][0]->name}}</a></h3>
            									<!--<h3><a href="{{route('products')}}">TRACTOR</a></h3>-->
            									<div class="hot-price">
												...
												<div class="default-button">
													<a href="{{route('products')}}">ADD TO CART</a>
												</div>
            								</div>
            							</div>
            							...
            							<div class="hot-deal-single-item">
            								<div class="hot-deal-image">
            									<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][1]->image)}}" alt="product"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
            								...
            								<div class="hot-deal-content">
            									<h3><a href="{{route('products')}}">{{ $data['product'][1]->name}}</a></h3>
            									<div class="hot-price">
            									...
            									<p>{{ $data['product'][1]->description}}</p>
												<div class="sale-end-time">
													<div data-countdown="2024/12/05"></div>
												</div>  
												<div class="default-button">
            							...
            							<div class="hot-deal-single-item">
            								<div class="hot-deal-image">
            									<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][2]->image)}}" alt="product"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
            								...
            								<div class="hot-deal-content">
            									<h3><a href="{{route('products')}}">{{ $data['product'][2]->name}}</a></h3>
            									<div class="hot-price">
            										<span class="regular-price">{{ $data['product'][2]->special_price}}</span>
            										<span class="sale-price">{{ $data['product'][2]->mrp_price}}</span>
            									</div>
            									<div class="product-review">
            										<i class="material-icons">grade</i>
            										<i class="material-icons">grade</i>
            									...
            									<p>{{ $data['product'][2]->description}}</p>
												<div class="sale-end-time">
													<div data-countdown="2024/12/05"></div>
												</div>  
												<div class="default-button">
            					...
            					<div class="best-seller sidebar-product-inner">
            						<div class="single-sidebar-product">
        								...
        								<div class="sidebar-main-content">
        									...
        									<a href="{{route('products')}}">Natural professor</a>			
            							</div>
            						</div>
            						<div class="single-sidebar-product">
        								<div class="single-sidebar-image">
        									<a href="{{route('products')}}"><img src="assets/img/product/torch3.jpg" alt="product"></a>
        								</div>
        								<div class="sidebar-main-content">
        									<div class="price-box">
            						...
            						<div class="single-sidebar-product">
        								<div class="single-sidebar-image">
        									<a href="{{route('products')}}"><img src="assets/img/product/torch4.jpg" alt="product"></a>
        								</div>
        								<div class="sidebar-main-content">
        									<div class="price-box">
            						...
            						<div class="single-sidebar-product">
        								<div class="single-sidebar-image">
        									<a href="{{route('products')}}"><img src="assets/img/product/torch5.jpg" alt="product"></a>
        								</div>
        								<div class="sidebar-main-content">
        									<div class="price-box">
        										<span class="regular-price">₹130.00</span>
            						...
            						<div class="single-sidebar-product">
        								<div class="single-sidebar-image">
        									<a href="{{route('products')}}"><img src="assets/img/product/torch6.jpg" alt="product"></a>
        								</div>
        								<div class="sidebar-main-content">
        									<div class="price-box">
        										<span class="regular-price">₹520.00</span>
        									</div>
        									<a href="{{route('products')}}">Dummy electronic</a>			
            							</div>
            						</div>
            						<div class="single-sidebar-product">
        								<div class="single-sidebar-image">
        									<a href="{{route('products')}}"><img src="assets/img/product/torch7.jpg" alt="product"></a>
        								</div>
        								<div class="sidebar-main-content">
        									<div class="price-box">
        										<span class="regular-price">₹130.00</span>
        									...
        									<a href="{{route('products')}}">Donec eu electronic</a>			
            							</div>
            						</div>
            					</div>
            				</div>            				
								    ...
								    <div class="home-tab-carousel product-grid-wrapper">
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			...
								    			<a href="{{route('products')}}"><img src="assets/img/product/torch1.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    		...
								    		<div class="grid-product-info">
	        									...
	        									<a href="{{route('products')}}">Dolorum fuga</a>
								    		</div>
								    	</div>
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<a href="{{route('products')}}"><img src="assets/img/product/torch2.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    		...
								    		<div class="grid-product-info">
	        									...
	        									<a href="{{route('products')}}">Condimentum Cap</a>
								    		</div>
								    	</div>
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<a href="{{route('products')}}"><img src="assets/img/product/torch5.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    		...
								    		<div class="grid-product-info">
	        									...
	        									<a href="{{route('products')}}">typesetting electronic</a>
								    		</div>
								    	</div>
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<span class="sale">-65%</span>
								    			<a href="{{route('products')}}"><img src="assets/img/product/torch7.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    		...
								    		<div class="grid-product-info">
	        									...
	        									<a href="{{route('products')}}">Laudantium furniture</a>
								    		</div>
								    	</div>
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<a href="{{route('products')}}"><img src="assets/img/product/torch9.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    	...
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<a href="{{route('products')}}"><img src="assets/img/product/torch10.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
								    	...
								    	<div class="single-grid-product">
								    		<div class="grid-product-image">
								    			<a href="{{route('products')}}"><img src="assets/img/product/torch11.webp" alt="product grid"></a>
            									<div class="product-action">
            										<a href="#"><i class="material-icons">favorite_border</i></a>
            										<a href="#"><i class="material-icons">autorenew</i></a>
            										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    ...
						    <div class="cat-slider1 product-grid-wrapper">
						    	...
						    	<div class="single-grid-product">
						    		...
						    		<div class="grid-product-info">
										...
										<a href="{{route('products')}}">Dummey headphone</a>
						    		</div>
						    	</div>
						    </div>	
						    ...
						    <div class="cat-slider2 product-grid-wrapper">
						    	...
						    	<div class="single-grid-product">
						    		...
						    		<div class="grid-product-info">
										...
										<a href="{{route('products')}}">Darun court</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    		...
						    		<div class="grid-product-info">
										...
										<a href="{{route('products')}}">Chokra bokra shirt</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    		...
						    		<div class="grid-product-info">
										...
										<a href="{{route('products')}}">Chawal manser pantu</a>
						    		</div>
						    	</div>
						    </div>	
							<div class="category-btn default-button">
            			...
            			<div class="col-12 col-sm-12">
						    ...
						    <div class="carousel-product product-grid-wrapper">
						    	...
						    	<div class="single-grid-product">
						    		...
						    		<div class="grid-product-info">
    									<div class="price-box">
    										...
    										<span class="sale-price">{{ $data['product'][4]->mrp_price}}</span>
    									</div>
						    	...
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
						    			<span class="sale">-15%</span>
						    			<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][6]->image)}}" alt="product grid"></a>
    									<div class="product-action">
    										<a href="#"><i class="material-icons">favorite_border</i></a>
    										<!-- <a href="#"><i class="material-icons">autorenew</i></a> -->
    										<a data-bs-toggle="modal" data-bs-target="#productQucikView" href="#"><i class="material-icons">visibility</i></a>
						    		...
						    		<div class="grid-product-info">
    									<div class="price-box">
    										<span class="regular-price">{{ $data['product'][6]->special_price}}</span>
    										<span class="sale-price">{{ $data['product'][6]->mrp_price}}</span>
    									</div>
    									<a href="{{route('products')}}">{{ $data['product'][6]->name}}</a>
						    		</div>
						    	</div>
						    	<div class="single-grid-product">
						    		<div class="grid-product-image">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							...
							<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][0]->image)}}" alt=""></a>
							</div>
							<div class="featured-product-content">
								<h5>{{ $data['product'][0]->name}}</h5>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
							<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][7]->image)}}" alt=""></a>
							</div>
							<div class="featured-product-content">
								<h5>{{ $data['product'][7]->name}} </h5>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
							<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][4]->image)}}" alt=""></a>
							</div>
							<div class="featured-product-content">
								<h5>{{ $data['product'][4]->name}} </h5>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
							<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][9]->image)}}" alt=""></a>
							</div>
							<div class="featured-product-content">
								<h5>{{ $data['product'][9]->name}}</h5>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
							<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][8]->image)}}" alt=""></a>
							</div>
							<div class="featured-product-content">
								<h5>{{ $data['product'][8]->name}}</h5>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
							<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][10]->image)}}" alt=""></a>
							</div>
							<div class="featured-product-content">
								<h5>Veer </h5>
							</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
							<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][5]->image)}}" alt=""></a>
							</div>
							<div class="featured-product-content">
								<h5>{{ $data['product'][5]->name}} </h5>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-sm-12 featured-product-top">
							<div class="featured-product-image">
							<a href="{{route('products')}}"><img src="{{asset('images/' . $data['product'][3]->image)}}" alt=""></a>
							</div>
							<div class="featured-product-content">
								<h5>{{ $data['product'][3]->name}}</h5>
							</div>
						</div>
