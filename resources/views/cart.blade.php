...
<td>{{$product['name']}} </td>
                            ...
                            <td>
                                <form action="{{route('change_qty', $id)}}" class="d-flex">
                                    ...
                                    >
                                        @if($product['quantity'] === 1) - @else - @endif
                                    </button>
                                    <input
                                        type="number"
                            ...
                            <td>₹{{$sub_total}}</td>
                            <td>
                                <a href="{{route('remove', [$id])}}" class="btn btn-danger btn-sm">Remove</a>
                            </td>
                        </tr>
    ...
    <div class="cartpage-button">
							<div class="primary-btn default-button">
								<a href="{{route('shopping.index')}}">Continue Shopping</a>
							</div>
							<div class="primary-btn default-button">
								<a href="#">Clear Cart</a>
					...
					<div class="cart-page-single-area cartpage-total-amount">
						<div class="cartpage-total-price">
							<div class="total-price-box">
								<p><span class="sub-t">Subtotal <span class="sub-t-p">₹{{$total}}</span></span></p>
								<p><span class="grand-t">Grand Total <span class="grand-t-p">₹{{$total}}</span></span></p>	
							</div>
