					...
					<div class="row">
						<div class="col-12 col-md-6">
							<div class="single-product-image">
								<div class="fotorama ">
									<a href="{{asset('images/' . $data['product'][0]->image)}}">
										<img src="{{asset('images/' . $data['product'][0]->image)}}" alt="product image">
									</a>
							...
							<div class="single-product-description">
								<div class="product-description-content">
									...
									<div class="price-box">
										...
										<span class="sale-price">₹1000.00</span>
									</div>
									...
									<div class="main-content">
										<p>Introducing the PRATAP Rechargeable Torch/Lamp, a high-performance lighting solution designed to meet your illumination needs. This pack of 6 torches ensures you're always equipped with reliable lighting wherever you go.</p>
									</div>
								</div>
