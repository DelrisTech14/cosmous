						...
						<div class="col-12 col-md-6">
							<div class="single-product-image">
								<div class="fotorama ">
									...
									<a href="{{asset('images/other_images' . $data['product'][0]->other_images[0])}}">
										<img src="{{asset('images/other_images' . $data['product'][0]->other_images)}}" alt="product image">
									</a>
							...
							<div class="single-product-description">
								<div class="product-description-content">
									...
									<div class="product-meta">
										<p class="availability">Availability : <span>{{ $data['product'][0]->availability}}</span></p>					
