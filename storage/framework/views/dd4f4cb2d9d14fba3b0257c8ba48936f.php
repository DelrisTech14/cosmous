				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
							<img src="<?php echo e(asset('assets/img/avatar5.png')); ?>" class='img-circle elevation-2' width="40" height="40" alt="">
						</a>
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
							...
							<a href="<?php echo e(route('admin.profile.update')); ?>" class="dropdown-item">
...
</html><?php /**PATH C:\laragon\www\torch\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>