...
<div class="container">
    <div class="d-flex justify-content-between align-items-center ">
        <h1>banner List</h1>
        <div>
            <a href="<?php echo e(route('banner.index')); ?>" class="btn btn-primary">Add banner</a>
        </div>
    </div>

    <form method="GET" action="<?php echo e(route('banner.view')); ?>" class="form-inline mb-3">
        ...
        <tbody>
            <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><img src="<?php echo e(asset('images/' . $banner->image)); ?>" alt="<?php echo e($banner->title); ?>" width="100"></td>
                    <td>
                ...
                <span >
                    ...
                    <td>
                        ...
                        <form action="<?php echo e(route('banner.delete', $banner->id)); ?>" method="POST" style="display:inline-block;">
                            <!--<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\torch\resources\views/banner/view.blade.php ENDPATH**/ ?>