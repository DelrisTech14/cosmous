			...
			<div class="row">
				<div class="col-12 col-sm-12">
					<div class="korando-breadcrump">
						<ul>
							<li><a href="<?php echo e(url('/dashboard')); ?>" title="Go to Home Page">Home</a></li>
							<li>Cart</li>
						</ul>
					</div>
				</div>
            ...
            <tbody>
                ...
                <?php if(session('cart')): ?>
                    <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $sub_total = $product['special_price'] * $product['quantity'];
                            $total += $sub_total;
                        ?>
...
<td><?php echo e($product['name']); ?> </td>
                            ...
                            <td>
                                <form action="<?php echo e(route('change_qty', $id)); ?>" class="d-flex">
                                    ...
                                    >
                                        <?php if($product['quantity'] === 1): ?> - <?php else: ?> - <?php endif; ?>
                                    </button>
                                    <input
                                        type="number"
                            ...
                            <td>
                                <a href="<?php echo e(route('remove', [$id])); ?>" class="btn btn-danger btn-sm">Remove</a>
                            </td>
                        </tr>
    ...
    <div class="cartpage-button">
							<div class="primary-btn default-button">
								<a href="<?php echo e(route('shopping.index')); ?>">Continue Shopping</a>
							</div>
							<div class="primary-btn default-button">
								<a href="#">Clear Cart</a>
					...
					<div class="cart-page-single-area cartpage-total-amount">
						<div class="cartpage-total-price">
							<div class="total-price-box">
								<p><span class="sub-t">Subtotal <span class="sub-t-p">₹<?php echo e($total); ?></span></span></p>
								<p><span class="grand-t">Grand Total <span class="grand-t-p">₹<?php echo e($total); ?></span></span></p>	
							</div>
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\torch\resources\views/cart.blade.php ENDPATH**/ ?>