            ...
            <tbody>
                <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><img src="<?php echo e($details['image']); ?>" width="50" height="50" /></td>
                        <td>
                            <form action="<?php echo e(route('cart.destroy', $id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\torch\resources\views/cart/index.blade.php ENDPATH**/ ?>