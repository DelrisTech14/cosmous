					...
					<div class="main-content">
						<div class="shop-page-header">
							<div class="shop-page-header-image">
								<a href="shop.php"><img src="<?php echo e(asset('images/' . $data['banner'][2]->image)); ?>" alt="one-column1"></a>
							</div>
						</div>
									...
									<div class="row product-grid-view">
										<div class="col-12 col-sm-6 col-md-6 col-lg-4 single-grid-product">
											<div class="grid-product-image">
												...
												<a href="<?php echo e(route('products')); ?>"><img src="<?php echo e(asset('images/' . $data['product'][0]->image)); ?>" alt="product grid"></a>
												...
												<a class="grid-btn" href="<?php echo e(route('cart')); ?>">Add to Cart</a>
											</div>
											<div class="grid-product-info">
												...
												<a href="<?php echo e(route('products')); ?>"><?php echo e($data['product'][0]->name); ?></a>
											</div>
										</div>
										<div class="col-12 col-sm-6 col-md-6 col-lg-4 single-grid-product">
											<div class="grid-product-image">
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-md-6  col-lg-7 col-xl-8">
													<div class="list-product-info">
														...
														<a class="learn-more-btn" href="<?php echo e(route('products')); ?>">Learn More</a>	 
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-md-6  col-lg-7 col-xl-8">
													<div class="list-product-info">
														...
														<p><?php echo e($data['product'][2]->description); ?>

														</p>
														<a class="learn-more-btn" href="<?php echo e(route('products')); ?>">Learn More</a>	 
														<div class="default-button">
															<a href="<?php echo e(route('cart')); ?>">ADD TO CART</a>
														</div>
													</div>	
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-md-6  col-lg-7 col-xl-8">
													<div class="list-product-info">
														...
														<p><?php echo e($data['product'][5]->description); ?></p>
														<a class="learn-more-btn" href="<?php echo e(route('products')); ?>">Learn More</a>	 
														<div class="default-button">
															<a href="<?php echo e(route('cart')); ?>">ADD TO CART</a>
														</div>
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-md-6  col-lg-7 col-xl-8">
													<div class="list-product-info">
														...
														<p><?php echo e($data['product'][1]->description); ?>
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-md-6  col-lg-7 col-xl-8">
													<div class="list-product-info">
														...
														<p><?php echo e($data['product'][4]->description); ?></p>
														<a class="learn-more-btn" href="<?php echo e(route('products')); ?>">Learn More</a>	 
														<div class="default-button">
															<a href="<?php echo e(route('cart')); ?>">ADD TO CART</a>
														</div>
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-md-6  col-lg-7 col-xl-8">
													<div class="list-product-info">
														...
														<p><?php echo e($data['product'][8]->description); ?></p>
														<a class="learn-more-btn" href="<?php echo e(route('products')); ?>">Learn More</a>	 
														<div class="default-button">
															<a href="<?php echo e(route('cart')); ?>">ADD TO CART</a>
														</div>
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-md-6  col-lg-7 col-xl-8">
													<div class="list-product-info">
														...
														<p><?php echo e($data['product'][7]->description); ?></p>
														<a class="learn-more-btn" href="<?php echo e(route('products')); ?>">Learn More</a>	 
														<div class="default-button">
															<a href="<?php echo e(route('cart')); ?>">ADD TO CART</a>
														</div>
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-md-6  col-lg-7 col-xl-8">
													<div class="list-product-info">
														...
														<p><?php echo e($data['product'][9]->description); ?></p>
														<a class="learn-more-btn" href="<?php echo e(route('products')); ?>">Learn More</a>	 
														<div class="default-button">
															<a href="<?php echo e(route('cart')); ?>">ADD TO CART</a>
														</div>
											...
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-md-6  col-lg-7 col-xl-8">
													<div class="list-product-info">
														...
														<p><?php echo e($data['product'][3]->description); ?></p>
														<a class="learn-more-btn" href="<?php echo e(route('products')); ?>">Learn More</a>	 
														<div class="default-button">
															<a href="<?php echo e(route('cart')); ?>">ADD TO CART</a>
														</div>
								...
								<div class="best-seller sidebar-product-inner">
									<div class="single-sidebar-product">
										<div class="single-sidebar-image">
											<a href="<?php echo e(route('products')); ?>"><img src="assets/img/product/sidebar/sidebar_product1.jpg" alt="product"></a>
										</div>
										<div class="sidebar-main-content">
											...
											<a href="<?php echo e(route('products')); ?>">Raftar</a>			
										</div>
									</div>
									<div class="single-sidebar-product">
										<div class="single-sidebar-image">
											<a href="<?php echo e(route('products')); ?>"><img src="assets/img/product/sidebar/sidebar_product2.jpg" alt="product"></a>
										</div>
										<div class="sidebar-main-content">
											<div class="price-box">
												<span class="regular-price">₹130.00</span>
											</div>
											<a href="<?php echo e(route('products')); ?>">Dummy product</a>			
										</div>
									</div>
									<div class="single-sidebar-product">
										<div class="single-sidebar-image">
											<a href="<?php echo e(route('products')); ?>"><img src="assets/img/product/sidebar/sidebar_product3.jpg" alt="product"></a>
										</div>
										<div class="sidebar-main-content">
											<div class="price-box">
									...
									<div class="single-sidebar-product">
										<div class="single-sidebar-image">
											<a href="<?php echo e(route('products')); ?>"><img src="assets/img/product/sidebar/sidebar_product4.jpg" alt="product"></a>
										</div>
										<div class="sidebar-main-content">
											<div class="price-box">
									...
									<div class="single-sidebar-product">
										<div class="single-sidebar-image">
											<a href="<?php echo e(route('products')); ?>"><img src="assets/img/product/sidebar/sidebar_product5.jpg" alt="product"></a>
										</div>
										<div class="sidebar-main-content">
											<div class="price-box">
									...
									<div class="single-sidebar-product">
										<div class="single-sidebar-image">
											<a href="<?php echo e(route('products')); ?>"><img src="assets/img/product/sidebar/sidebar_product6.jpg" alt="product"></a>
										</div>
										<div class="sidebar-main-content">
											<div class="price-box">
												<span class="regular-price">₹130.00</span>
											</div>
											<a href="<?php echo e(route('products')); ?>">SIR JOHN</a>			
										</div>
									</div>
								</div>
							</div>  
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\torch\resources\views/shopping/view.blade.php ENDPATH**/ ?>