					...
					<div class="customer-area contact-us-area">	
                        ...
                        <form method="POST" action="<?php echo e(route('login.custom')); ?>">
                            ...
                            <div class="korando-form-group form-group">
                                ...
                                <?php if($errors->has('emailPassword')): ?>
                                <span class="text-danger"><?php echo e($errors->first('emailPassword')); ?></span>
                                <?php endif; ?>
							</div>	
					...
					<div class="customer-area contact-us-area">	
						...
						<form action="#">
							...
							<div class="primary-btn default-button">
								<a href="<?php echo e(route('register-user')); ?>">Create an Account</a>
							</div>
						</form>							
					</div>
				</div>            		
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\torch\resources\views/auth/login.blade.php ENDPATH**/ ?>